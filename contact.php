...
<body>
    ...
    <!-- START EVENTS -->
    <section class="section header-bg-img h-25vh align-items-center d-flex" id="home_update">
    ...
    <!-- START CONTACT -->
    <section class="section bg-muted " id="contact">
        <div class="container ">
            <div class="col-lg-12">
                                        ...
                                        <div class="form-kerri contact_form">
                                                <form>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="mt-3" >
                                                            <h5 class="mb-0 contact_detail-title fw-bold "><span class="iconify" data-icon="eva:phone-call-fill"></span>&nbsp;Call Us On</h5>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="mt-3">
                                                            <h5 class="mb-0 contact_detail-title fw-bold"><span class="iconify" data-icon="eva:pin-fill"></span>&nbsp;Visit Office</h5>
                                                    ...
                                                    <div class="row">
                                                        <div class="mt-3">
                                                            <h5 class="mb-0 contact_detail-title fw-bold"> <span class="iconify" data-icon="bxs:time"></span>&nbsp;Open</h5>
