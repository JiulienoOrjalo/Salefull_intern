	...
	<nav class="navbar navbar-expand-lg custom-nav navbar-light fixed-top sticky">
	    <div class="container">
	        <a class="navbar-brand pt-0 logo" href="#">
                <!-- <img src="images/salefull-logo.png" alt="" class="img-fluid logo-light" style="width: 60px; height: auto;">
                <img src="images/lsalefull-logo.png" alt="" class="img-fluid logo-light" style="width: 60px; height: auto;"> -->
            </a>
