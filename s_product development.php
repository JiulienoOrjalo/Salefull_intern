            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="text-center" data-aos="fade-up">
                        <h2><span class="fw-bold"><span class="text-danger">Innovation Equals Growth</span></span></h2>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="mt-3" data-aos="fade-right">
                        <img src="images/p_development.jpeg" alt="" class="img-fluid">
                    </div>
                </div>
